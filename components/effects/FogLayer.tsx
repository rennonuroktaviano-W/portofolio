export function FogLayer() {
  return (
    ...
    >
      <div
        className="fog-layer absolute -left-1/4 bottom-[8%] h-40 w-[150vw] rounded-full opacity-40 blur-3xl"
        style={{
          background:
      ...
      />
      <div
        className="fog-layer absolute -right-1/4 top-[30%] h-48 w-[140vw] rounded-full opacity-30 blur-3xl"
        style={{
          background:
      ...
      />
      <div
        className="fog-layer absolute left-[-20%] top-[62%] h-36 w-[120vw] rounded-full opacity-25 blur-2xl"
        style={{
          background:
