  ...
  return (
    ...
    >
      ...
      <div className="searchlight-beam absolute bottom-[-10px] left-1/2 h-[340px] w-[54px] origin-bottom -ml-[27px]">
        <div className="searchlight-flicker absolute inset-0 bg-[linear-gradient(to_top,rgba(230,184,74,0.55),rgba(230,184,74,0.18)_42%,transparent_74%)] blur-[2px] [clip-path:polygon(50%_100%,0_0,100%_0)]" />
      </div>

      <div className="searchlight-beam searchlight-beam-slow absolute bottom-[-10px] left-1/2 h-[360px] w-[170px] origin-bottom -ml-[85px]">
        <div className="absolute inset-0 bg-[linear-gradient(to_top,rgba(230,184,74,0.26),rgba(230,184,74,0.08)_45%,transparent_74%)] blur-md md:blur-xl [clip-path:polygon(50%_100%,0_0,100%_0)]" />
      </div>
    </div>
  );
}