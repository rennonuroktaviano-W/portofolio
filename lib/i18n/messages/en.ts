...
export const en: Messages = {
  ...
  final: {
    ...
    para:
      "This site is built from real projects and lessons — if something caught your eye, let's build together.",
    footer: "© {year} {name} — built with Next.js + TypeScript · AI-assisted",
  },
  notFound: {
